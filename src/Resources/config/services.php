...
use Spiriit\Bundle\CommitHistoryBundle\Service\FeedFetcher as BundleFeedFetcher;
...
return static function (ContainerConfigurator $container): void {
    ...
    // Bundle's FeedFetcher (decorator that adds commits list caching)
    $services->set('spiriit_commit_history.feed_fetcher', BundleFeedFetcher::class)
        ->args([
    ...
    $services->alias(BundleFeedFetcherInterface::class, 'spiriit_commit_history.feed_fetcher');
    ...
    $services->set('spiriit_commit_history.command.refresh_cache', RefreshCacheCommand::class)
        ->args([
            service(BundleFeedFetcherInterface::class),
            service('cache.app'),
            param('spiriit_commit_history.provider_hash'),
        ])
        ->tag('console.command');
